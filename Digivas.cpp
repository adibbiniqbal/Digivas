...
void iDraw()
{
	...
	if (mode == 2)
	{
		...
		iText(50, 890, "3. To draw a rectangle, select the rectangle tool and click where you want the bottom left corner of the rectangle");
		...
		iText(50, 830, "6. To write text, select the text tool and click where you want to write, press enter to finish writing the text");
		iText(50, 810, "7. To change the color of the currently selected tool, click on the color you want to change to");
		...
		iText(50, 670, "14. To go back to the menu, click on Menu");
		iSetColor(255, 255, 255);
		iFilledRectangle(980, 50, 50, 20);
		iSetColor(0, 0, 0);
		iText(990, 55, "Menu");
	...
	if (mode == 3)
	{
		...
		iText(50, 890, "This project is made for the CSE 102 course offered by BUET CSE department");
